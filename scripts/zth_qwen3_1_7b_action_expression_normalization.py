...
def closeout(out: Path) -> None:
    ...
    for task_id,task in tasks.items():
        ...
        canonical_correct=bool(norm["status"] == task["expected_status"] and norm["canonical_operation"] == task["expected_canonical_operation"])
