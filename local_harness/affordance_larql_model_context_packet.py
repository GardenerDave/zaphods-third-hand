...
def build_model_instruction(runtime_rule: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            "Answer using this required skeleton:",
            ...
            "Do not recommend OpenAI Inference API, Hugging Face Inference API, generic cloud services, PyTorch with a different compatible GPU, or replacing hardware as the primary answer.",
