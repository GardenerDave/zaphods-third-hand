...
|---|---|---|---:|
| `baseline_direct_cuda_on_navigator` | direct CUDA-on-Navigator question | `needs_review` | `true` |
| `baseline_cross_host_boundary` | cross-host boundary | `needs_review` | `true` |
...
| `baseline_reverify_before_action` | reverify-before-action behavior | `needs_review` | `true` |
