...
- Input review verdict: `baseline_review_requires_scorer_repair`
...
Accept active-host applicability phrasing when the response includes the exact structured labels and says the candidate applies only when the active host matches the relevant host/profile constraints.
