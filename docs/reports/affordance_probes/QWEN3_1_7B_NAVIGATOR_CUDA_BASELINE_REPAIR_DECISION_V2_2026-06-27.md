...
Accept the v2 proposal for bounded structured prompt/scorer repair packet drafting only. Baseline v2 improved to five passing prompts with no true failures; remaining work is one structured split-workflow prompt repair and one no-durable-promotion LoRA wording scorer repair.
