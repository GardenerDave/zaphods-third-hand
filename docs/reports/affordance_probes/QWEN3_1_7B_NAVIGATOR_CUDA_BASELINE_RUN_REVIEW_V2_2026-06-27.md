...
Baseline v2 improved from v1: five prompts passed, one no-durable-promotion check appears to be a remaining scorer wording false negative around LoRA phrasing, and the split-workflow active-host prompt remains a real model weakness requiring a stronger structured prompt repair.
